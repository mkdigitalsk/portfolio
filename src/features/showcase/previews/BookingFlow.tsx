...
const STAYS = [
  { emoji: '🏖️', place: 'Beach Resort', rating: '4.8', nights: '5 nights', price: '€120' },
  { emoji: '🏔️', place: 'Mountain Lodge', rating: '4.9', nights: '4 nights', price: '€95' },
  { emoji: '🏙️', place: 'City Hotel', rating: '4.6', nights: '3 nights', price: '€110' },
]
        ...
        <AnimatePresence mode="wait">
          {screen === 0 ? (
            ...
            >
              ...
              >
                <Box sx={{ fontSize: 12, fontWeight: 600, color: 'text.primary', mb: 0.75 }}>Where to?</Box>
              ...
              {STAYS.map((s, i) => (
                ...
                >
                  ...
                  <Box sx={{ flex: 1, minWidth: 0 }}>
                    <Box sx={{ fontSize: 11.5, fontWeight: 600, color: 'text.primary' }}>{s.place}</Box>
            ...
            >
              ...
              >
                <Box sx={{ fontSize: 22 }}>{featured.emoji}</Box>
                <Box sx={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
                  <Box sx={{ fontSize: 13, fontWeight: 600 }}>{featured.place}</Box>
